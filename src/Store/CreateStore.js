...
function CreateStore(props) {
  const [data, setData] = useState([
    ...
    },
    {
      ...
      category: "technology",
      title:
        "Pixel Watch 2 Initial Review: The right moves in the right places",
    },
    {
      id: 4,
    ...
    {
      id:16,
      title:'Fitness and Exercise: Health Benefits, How to Get Started, and How to Get Better',
      img:'https://images.everydayhealth.com/images/everything-you-need-know-about-fitness-1440x810.jpg?sfvrsn=2fee0a3b_4',
      category:'fitness'
    },
    {
      id:17,
      title:'Running: What It Is, Health Benefits, How to Get Started, and How to Get Better',
